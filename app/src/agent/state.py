...
# TODO: Refactor according to https://langchain-ai.github.io/langgraph/how-tos/graph-api/#define-input-and-output-schemas
class AgentState(TypedDict):
    ...
    answer: Annotated[str, ..., "The answer to the user's query. If the query is simple and can be answered directly, provide the answer here."]
    follow_up_questions: Annotated[list[str], ..., "List of follow-up questions to clarify the user's intent if the initial query is ambiguous or incomplete."]
    ...
    knowledge_search_query: Annotated[list, ..., "List of search queries generated to gather more information for answering the user's query."]
...
class KnowledgeSearchQueryGenerationState(TypedDict):
    ...
    """
    knowledge_search_query: list[KnowledgeSearchQuery]
